...
const (
	...
	ErrCreatePostgresWaitRole             = "failed to create Postgres wait Role"
	ErrCreatePostgresWaitRoleBinding      = "failed to create Postgres wait RoleBinding"
	ErrGeneratePostgresWaitRole           = "failed to generate Postgres wait Role"
	ErrGeneratePostgresWaitRoleBinding    = "failed to generate Postgres wait RoleBinding"
	ErrGetPostgresWaitRole                = "failed to get Postgres wait Role"
	ErrGetPostgresWaitRoleBinding         = "failed to get Postgres wait RoleBinding"
	ErrUpdatePostgresWaitRole             = "failed to update Postgres wait Role"
	ErrUpdatePostgresWaitRoleBinding      = "failed to update Postgres wait RoleBinding"
